  ...
  <div className="grid grid-cols-12 gap-10">
          ...
          {entries.map((entry) => (
            ...
            >
              <div className="absolute -top-8 left-0 right-0 text-center opacity-0 group-hover:opacity-100 transition-opacity">
                <span className="text-[10px] font-black italic">₪{entry.value}</span>
              </div>
            </div>
          ))}
        </div>
    ...
    <div className="col-span-12 lg:col-span-4 space-y-6">
      <Card variant="emerald" className="p-10 space-y-6">
        ...
        <h3 className="text-3xl font-black italic">Momentum</h3>
        <p className="font-bold opacity-80 italic">{momentumText}</p>
      ...
      <Card className="p-10">
        ...
        <h4 className="font-black text-xl italic text-slate-800">Scope</h4>
        <p className="text-sm font-bold text-slate-600 leading-relaxed mt-2 italic">
          {scopeText}
        </p>
      </Card>
    </div>
