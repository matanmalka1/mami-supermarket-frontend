            ...
            <div className="space-y-4 font-bold text-gray-700">
              {[
                ...
                >
                  ...
                  >
                    <div
                      className={`w-4 h-4 bg-white rounded-full transition-transform ${notificationSettings[item.id as keyof typeof notificationSettings] ? "translate-x-6" : "translate-x-0"}`}
                    />
                  </div>
                </label>
              ))}
          ...
          <div className="bg-blue-50 border border-blue-100 p-10 rounded-[3rem] space-y-6">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm font-medium text-blue-900/60 leading-relaxed ">
                Your account is secured with end-to-end encryption and
                biometric-ready protocols.
              </p>
            </div>
