  ...
  return (
    <div className="rounded-b-[2rem] border-t border-slate-100 bg-white px-8 pb-10 pt-8 text-center">
      ...
      <div className="mt-8 flex justify-center">
        <button
          onClick={onGoHome}
          className="flex items-center justify-center gap-2 rounded-2xl bg-emerald-600 px-10 py-3 text-sm font-black uppercase tracking-[0.4em] text-white shadow-xl transition hover:bg-emerald-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-200"
        >
