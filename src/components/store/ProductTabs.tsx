      ...
      case "Specifications":
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-24 animate-in fade-in slide-in-from-bottom-2 duration-300">
            {specs.length === 0 ? (
              <p className="text-sm text-gray-500 font-bold">No specs available.</p>
            ) : (
              specs.map((spec, idx) => (
            ...
            {product && (
              <div className="flex gap-4">
                <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100">
                  ...
                  <p className="text-[10px] font-black uppercase">Quality Assured</p>
                </div>
                <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100">
                  <RefreshCcw className="text-blue-600 mb-2" size={20} />
                  <p className="text-[10px] font-black uppercase">Returns info pending</p>
                </div>
              </div>
            )}
          </div>
        ...
        return (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
            <div className="flex items-start gap-4">
              ...
              <div><p className="font-bold text-gray-900">Shipping</p><p className="text-sm text-gray-500 font-medium">Shipping details pending backend support.</p></div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div><p className="font-bold text-gray-900">Returns</p><p className="text-sm text-gray-500 font-medium">Returns policy not connected to backend yet.</p></div>
            </div>
          </div>
        );
      default:
