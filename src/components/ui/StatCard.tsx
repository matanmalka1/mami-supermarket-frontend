...
const StatCard: React.FC<StatCardProps> = ({ 
  ...
  <div 
    ...
    className={`bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm transition-all ${
      onClick ? 'cursor-pointer hover:shadow-xl hover:-translate-y-1 active:scale-95' : ''
    } ${className}`}
  >
    <p className="text-[10px] text-gray-400 font-black uppercase tracking-[0.2em] mb-4">{label}</p>
