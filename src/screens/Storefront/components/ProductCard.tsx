  ...
  return (
    ...
    >
      <div className="relative rounded-2xl overflow-hidden aspect-square mb-4 bg-gray-100">
        ...
        {item.tag && (
          <span className="absolute top-4 left-4 bg-[#008A45] text-white text-[10px] font-black px-3 py-1 rounded-full uppercase tracking-widest">
            {item.tag}
          </span>
        )}
        <button
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center gap-2">
          <span className="text-xl font-black text-[#008A45]">
