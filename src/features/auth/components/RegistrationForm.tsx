    ...
    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 max-w-lg">
      <div className="grid grid-cols-2 gap-6">
        <div className="space-y-3">
          <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest block px-1">First Name</label>
        ...
        <div className="space-y-3">
          <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest block px-1">Last Name</label>
      ...
      <div className="space-y-3">
        <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest block px-1">Israeli Phone Number</label>
        <div className="flex rounded-2xl overflow-hidden border border-gray-100 shadow-sm">
          <div className="px-6 py-4 bg-white border-r border-gray-50 flex items-center gap-2 text-sm font-black text-gray-600">+972</div>
