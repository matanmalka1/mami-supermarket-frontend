    ...
    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 max-w-lg">
      <div className="grid grid-cols-2 gap-6">
        <div className="space-y-3">
          <label className="text-[10px] text-gray-400 uppercase tracking-widest block px-1">
            First Name
          </label>
          <input
            {...register("firstName")}
      ...
      <div className="space-y-3">
        ...
        <div className="flex rounded-2xl overflow-hidden border border-gray-100 shadow-sm">
          <div className="px-6 py-4 bg-white border-r border-gray-50 flex items-center gap-2 text-sm text-gray-600">
            +972
          </div>
          <input
            {...register("phone")}
            className="flex-1 py-4 px-6 outline-none bg-white font-bold"
      ...
      <div className="flex items-center gap-4 px-1">
        <input
          ...
          className="w-6 h-6 rounded-lg border-2 border-gray-200 text-[#16A34A] focus:ring-[#16A34A]"
          id="acceptTerms"
        />
        <label
          htmlFor="acceptTerms"
          className="text-sm font-bold text-gray-400 cursor-pointer"
        >
          I agree to the{" "}
